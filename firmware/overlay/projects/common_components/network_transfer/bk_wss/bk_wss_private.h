...
typedef struct {
	...
	uint32_t recording_bytes_sent;
	uint16_t commit_pending;
	uint16_t response_audio_done_pending;
	uint16_t response_audio_started;
	uint16_t response_audio_idle_checks;
}rtc_session;
